(() => {
  ...
  function gallery() {
    ...
    const collectionSeries = "insect";
    const collectionLabel = "むし";
    const collectionBadges = [{rarity:"common",id:"ant",label:"アリ"},{rarity:"common",id:"bee",label:"ハチ"},{rarity:"common",id:"beetle",label:"カブトムシ"},{rarity:"common",id:"butterfly",label:"チョウ"},{rarity:"common",id:"dragonfly",label:"トンボ"},{rarity:"common",id:"grasshopper",label:"バッタ"},{rarity:"common",id:"ladybug",label:"テントウムシ"},{rarity:"common",id:"stag-beetle",label:"クワガタ"},{rarity:"rare",id:"caterpillar",label:"イモムシ"},{rarity:"rare",id:"cicada",label:"セミ"},{rarity:"rare",id:"firefly",label:"ホタル"},{rarity:"rare",id:"praying-mantis",label:"カマキリ"},{rarity:"super-rare",id:"atlas-beetle",label:"ヘラクレスオオカブト"},{rarity:"super-rare",id:"jewel-beetle",label:"宝石カブト"},{rarity:"secret",id:"rainbow-butterfly",label:"虹色のチョウ"}];
