(() => {
  ...
  const MANIFESTS = {
    ...
    plants: { id:"plants", title:"植物LAB", unit:"植物の育ち", icon:"🌱", summary:"水・光・時間を変えて、植物の育ち方と姿の変化を見ます。", accent:"#4f934b", modelNote:"植物の成長に関わる条件を比べやすくするため、芽・葉・花の変化を単純化しています。" },
  ...
  const CHALLENGES = {
    "living": [
      "明るさだけを変えると、見つかる数はどう変わる？",
      "地面の湿り方だけを変えて、同じ条件と比べよう。",
      "いちばん見つかりやすい組み合わせを探そう。"
    ],
    "plants": [
      "日数を同じにして、水だけを変えて比べよう。",
      "水を適量にして、日光のあり・なしを比べよう。",
      "花が咲く条件と日数を探そう。"
    ],
    "insects": [
